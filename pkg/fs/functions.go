...
func OpenFile(fs FS, name *types.URL, flag int, perm FileMode) (File, error) {
...
func Open(fs FS, name *types.URL) (File, error) {
	//nolint:wrapcheck //wrapping adds nothing here
...
// truncated.
func Create(fs FS, name *types.URL) (File, error) {
	//nolint:wrapcheck //wrapping adds nothing here
...
func ReadFile(fs FS, name *types.URL) ([]byte, error) {
	//nolint:wrapcheck //wrapping adds nothing here
...
// overwritten.
func WriteFullFile(fs FS, name *types.URL, data []byte) error {
	//nolint:wrapcheck //wrapping adds nothing here
