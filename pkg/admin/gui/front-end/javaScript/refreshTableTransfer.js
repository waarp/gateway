const refreshID = setInterval(refreshTransfers, 5000);
...
function refreshTransfers () {
    ...
    const request = new Request('/webui/transfer_monitoring?partial=true', {redirect: 'error'})
    ...
    fetch(request)
        ...
        .catch(err => {
            ...
            console.error('Error during page refresh:', err);
        });
}
