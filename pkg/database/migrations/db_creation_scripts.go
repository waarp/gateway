...
CREATE TABLE IF NOT EXISTS 'certificates' ('id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'owner_type' TEXT NOT NULL, 'owner_id' INTEGER NOT NULL, 'name' TEXT NOT NULL, 'private_key' TEXT NULL, 'ssh_public_key' TEXT NULL, 'certificate' TEXT NULL);
...
CREATE TABLE IF NOT EXISTS "version" ("current" TEXT NOT NULL);
INSERT INTO "version" ("current") VALUES ('0.0.0');
CREATE TABLE IF NOT EXISTS "certificates" ("id" BIGSERIAL PRIMARY KEY  NOT NULL, "owner_type" VARCHAR(255) NOT NULL, "owner_id" BIGINT NOT NULL, "name" VARCHAR(255) NOT NULL, "private_key" TEXT NULL, "ssh_public_key" TEXT NULL, "certificate" TEXT NULL);
CREATE UNIQUE INDEX "UQE_certificates_cert" ON "certificates" ("owner_type","owner_id","name");
...
CREATE TABLE IF NOT EXISTS version (current TEXT NOT NULL);
INSERT INTO version (current) VALUES ('0.0.0');
CREATE TABLE IF NOT EXISTS certificates (id BIGINT(20) PRIMARY KEY AUTO_INCREMENT NOT NULL, owner_type VARCHAR(255) NOT NULL, owner_id BIGINT(20) NOT NULL, name VARCHAR(255) NOT NULL, private_key TEXT NULL, ssh_public_key TEXT NULL, certificate TEXT NULL);
CREATE UNIQUE INDEX UQE_certificates_cert ON certificates (owner_type,owner_id,name);
