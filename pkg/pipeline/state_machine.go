...
const (
	...
	stateStartData     statemachine.State = "start data"
...
var pipelineSateMachine = statemachine.MachineModel{
	...
	StateMap: statemachine.StateMap{
		...
		statePreTasksDone:  statemachine.CanTransitionTo(stateStartData, stateError),
		stateStartData:     statemachine.CanTransitionTo(stateReading, stateWriting, stateError),
