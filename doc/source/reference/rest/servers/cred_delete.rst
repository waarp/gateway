...
.. http:delete:: /api/servers/(string:server_name)/credentials/(string:auth_value_name)
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         DELETE https://my_waarp_gateway.net/api/servers/gw_r66/credentials/r66_certificate HTTP/1.1
