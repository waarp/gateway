...
.. http:post:: /api/servers/(string:server_name)/accounts/(string:login)/credentials
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         POST https://my_waarp_gateway.net/api/servers/sftp_server/accounts/toto/credentials HTTP/1.1
   ...
   **Exemple de réponse**
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/servers/sftp_server/accounts/toto/credentials/toto_pubkey
