...
.. http:post:: /api/servers/(string:server)/accounts/(string:login)/certificates
   ...
   :statuscode 401: Le serveur ou le compte demandés n'existent pas
   ...
   .. admonition:: Exemple de requête
      ...
      .. code-block:: http
         ...
         POST https://my_waarp_gateway.net/api/servers/serveur_sftp/accounts/toto/certificates HTTP/1.1
   ...
   .. admonition:: Exemple de réponse
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/servers/serveur_sftp/accounts/toto/certificates/certificat_toto