...
.. http:get:: /api/servers/(string:server)/accounts/(string:login)/certificates
   ...
   :statuscode 404: Le serveur ou le compte demandés n'existent pas
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         GET https://my_waarp_gateway.net/api/servers/serveur_sftp/accounts/toto/certificates?limit=5 HTTP/1.1
