...
.. http:post:: /api/servers/(string:server)/certificates
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         POST https://my_waarp_gateway.net/api/servers/serveur_sftp/certificates HTTP/1.1
   ...
   **Exemple de réponse**
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/servers/server/serveur_sftp/certificates/certificat_sftp