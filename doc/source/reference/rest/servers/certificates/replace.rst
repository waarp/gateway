...
.. http:put:: /api/servers/(string:server)/certificates/(string:cert_name)
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         PUT https://my_waarp_gateway.net/api/servers/serveur_r66/certificates/certificat_r66 HTTP/1.1
         Authorization: Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ==
         Content-Type: application/json
         Content-Length: 652

         {
           "name": "certificat_r66_new",
   ...
   **Exemple de réponse**
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/servers/serveur_r66/certificates/certtificat_r66