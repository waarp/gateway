Remplacer un compte partenaire
==============================

.. http:put:: /api/remote_accounts/(int:account_id)

   Remplace le compte partenaire portant le numéro ``account_id`` par celui renseigné
   ...
   **Exemple de requête**
       ...
       .. code-block:: http
          ...
          PUT https://my_waarp_gateway.net/api/remote_accounts/1 HTTP/1.1
