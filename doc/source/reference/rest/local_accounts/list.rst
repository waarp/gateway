...
.. http:get:: /api/local_accounts
   ...
   **Requête**
   ...
   :type order: [asc|desc]
   :param agent: Filtre uniquement les comptes rattaché au serveur portant ce numéro.
      Peut être renseigné plusieurs fois pour filtrer plusieurs serveurs.
   :type partner: uint64
   ...
   **Exemple de requête**
       ...
       .. code-block:: http
          ...
          GET https://my_waarp_gateway.net/api/local_accounts?limit=10&order=desc&agent=1 HTTP/1.1
   ...
   **Réponse**
   ...
   :resjsonarr number localAgentID: L'identifiant unique du serveur auquel le
      compte est rattaché
