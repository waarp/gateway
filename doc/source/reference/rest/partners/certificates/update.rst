...
.. http:patch:: /api/partners/(string:partner)/certificates/(string:cert_name)
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         PATCH https://my_waarp_gateway.net/api/partners/waarp_sftp/certificates/certificat_waarp HTTP/1.1
