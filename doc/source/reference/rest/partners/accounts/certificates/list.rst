...
.. http:get:: /api/partners/(string:partner)/accounts/(string:login)/certificates
   ...
   :statuscode 404: Le partenaire ou le compte demandés n'existent pas
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         GET https://my_waarp_gateway.net/api/partners/waarp_sftp/accounts/titi/certificates?limit=5 HTTP/1.1
