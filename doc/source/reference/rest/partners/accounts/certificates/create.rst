...
.. http:post:: /api/partners/(string:partner)/accounts/(string:login)/certificates
   ...
   **Exemple de requête**
   ...
   .. code-block:: http
      ...
      POST https://my_waarp_gateway.net/api/partners/waarp_r66/accounts/titi/certificates HTTP/1.1
   ...
   **Exemple de réponse**
   ...
   .. code-block:: http
      ...
      Location: https://my_waarp_gateway.net/api/partners/waarp_r66/accounts/titi/certificates/certificat_waarp
