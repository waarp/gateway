...
.. http:post:: /api/partners/(string:partner)/accounts/(string:login)/certificates
   ...
   :statuscode 401: Le partenaire ou le compte demandés n'existent pas
   ...
   .. admonition:: Exemple de requête
      ...
      .. code-block:: http
         ...
         POST https://my_waarp_gateway.net/api/partners/waarp_sftp/accounts/titi/certificates HTTP/1.1
   ...
   .. admonition:: Exemple de réponse
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/partners/waarp_sftp/accounts/titi/certificates/certificat_titi
