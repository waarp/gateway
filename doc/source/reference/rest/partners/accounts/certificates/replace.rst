...
.. http:put:: /api/partners/(string:partner)/accounts/(string:login)/certificates/(string:cert_name)
   ...
   **Exemple de requête**
      ...
      .. code-block:: http
         ...
         PUT https://my_waarp_gateway.net/api/partners/waarp_r66/accounts/titi/certificates/certificat_titi HTTP/1.1
   ...
   **Exemple de réponse**
      ...
      .. code-block:: http
         ...
         Location: https://my_waarp_gateway.net/api/partners/waarp_r66/accounts/titi/certificates/certificat_waarp_new
