...
.. program:: waarp-gateway server auth add

.. describe:: waarp-gateway server <SERVER> auth add
...
.. code-block:: shell
   ...
   waarp-gateway -a 'http://user:password@localhost:8080' server auth 'gw_r66' add -n 'r66_cert' -t 'ssh_private_key' -v './gw_ssh.key'
