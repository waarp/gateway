...
require (
	...
	modernc.org/sqlite v1.29.6 //do not update, uses go version >1.20
	xorm.io/builder v0.3.13
	xorm.io/xorm v1.3.2 //do not update, newer versions break "SELECT FOR UPDATE" on sqlite & postgres
)

// Indirect dependencies. Do not update manually, leave it to the direct dependencies.
require (
...
require github.com/slayercat/GoSNMPServer v0.5.2
