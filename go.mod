...
require (
	...
	code.waarp.fr/lib/pesit v0.1.6-0.20260504135833-8112588d40a6
...
//freeze rclone to v1.72.1 as v1.73 is currently bugged with Azfile
replace github.com/rclone/rclone => github.com/rclone/rclone v1.72.1
...
require (
	...
	github.com/Files-com/files-sdk-go/v3 v3.3.65 // indirect
